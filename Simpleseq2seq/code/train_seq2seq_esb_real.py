...
sys.stdout = open('addition_survival memo.txt', 'w')
...
model.save_params('addition(real)_sc.pkl')
model2.save_params('addition(real)_sc(2).pkl')
model3.save_params('addition(real)_sc(3).pkl')
model4.save_params('addition(real)_sc(4).pkl')
model5.save_params('addition(real)_sc(5).pkl')
...
plt.title('Addition Real Majority Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('Addition_RealMajority_Acc.png')
plt.show()
