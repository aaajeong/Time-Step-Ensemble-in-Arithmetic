...
sys.stdout = open('4-plusminus_real_test(1).txt', 'w')
...
trainer.plot_loss(num[0], '4', 'real')
trainer2.plot_loss(num[1], '4', 'real')
trainer3.plot_loss(num[2], '4', 'real')
trainer4.plot_loss(num[3], '4', 'real')
trainer5.plot_loss(num[4], '4', 'real')
...
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('4-plusminus_real.png')
plt.show()
