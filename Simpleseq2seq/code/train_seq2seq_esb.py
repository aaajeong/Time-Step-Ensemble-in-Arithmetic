...
sys.stdout = open('2-addition_survival memo.txt', 'w')
...
model.save_params('2-addition(survival)_sc.pkl')
model2.save_params('2-addition(survival)_sc(2).pkl')
model3.save_params('2-addition(survival_sc(3).pkl')
model4.save_params('2-addition(survival)_sc(4).pkl')
model5.save_params('2-addition(survival)_sc(5).pkl')
...
plt.title('2-Addition survival Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('2-Addition_survival_Acc.png')
plt.show()
