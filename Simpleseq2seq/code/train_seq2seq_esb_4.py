...
sys.stdout = open('5-addition_esb memo.txt', 'w')
...
trainer.plot_loss(num[0], '5')
trainer2.plot_loss(num[1], '5')
trainer3.plot_loss(num[2], '5')
trainer4.plot_loss(num[3], '5')
trainer5.plot_loss(num[4], '5')
...
model.save_params('5-addition(esb)_sc.pkl')
model2.save_params('5-addition(esb)_sc(2).pkl')
model3.save_params('5-addition(es)_sc(3).pkl')
model4.save_params('5-addition(esb)_sc(4).pkl')
model5.save_params('5-addition(esb)_sc(5).pkl')
...
plt.title('5-Addition Ensemble Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('5-Addition_Ensemble_Acc.png')
plt.show()
