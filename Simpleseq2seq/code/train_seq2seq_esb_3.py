...
sys.stdout = open('4-addition_survival memo.txt', 'w')
...
trainer.plot_loss(num[0], '4')
trainer2.plot_loss(num[1], '4')
trainer3.plot_loss(num[2], '4')
trainer4.plot_loss(num[3], '4')
...
model.save_params('4-addition(survival)_sc.pkl')
model2.save_params('4-addition(survival)_sc(2).pkl')
model3.save_params('4-addition(survival)_sc(3).pkl')
model4.save_params('4-addition(survival)_sc(4).pkl')
model5.save_params('4-addition(survival)_sc(5).pkl')
...
plt.title('4-Addition survival Accuracy')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('4-Addition_survival_Acc.png')
plt.show()
