...
sys.stdout = open('4-plusminus_survival_test(1).txt', 'w')
...
trainer.plot_loss(num[0], '4', 'survival')
trainer2.plot_loss(num[1], '4', 'survival')
trainer3.plot_loss(num[2], '4', 'survival')
trainer4.plot_loss(num[3], '4', 'survival')
trainer5.plot_loss(num[4], '4', 'survival')
...
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('4-plusminus_survival.png')
plt.show()
