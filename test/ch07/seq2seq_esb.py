...
from common.util import eval_seq2seq, eval_seq2seq_esb
...
model1.load_params('ch07/Training/ReverseSeq.pkl')
model_list = []
...
# verbose = FALSE
# results =  eval_seq2seq_esb(model_list, question, correct,
#                             id_to_char, verbose, is_reverse)
# correct_num +=  eval_seq2seq_esb(model_list, question, correct,
#                             id_to_char, verbose, is_reverse)

# print(correct_num)
# correct_num += eval_seq2seq_esb(model, model1, question, correct,
#                             id_to_char, verbose, is_reverse)
